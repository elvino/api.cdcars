 ...
 * </p>
 */
public final class ContextualDataModel extends AbstractDataModel {
  
  private static final Logger log = LoggerFactory.getLogger(ContextualDataModel.class);
  ...
  /**
   * <p>
   * Creates a new {@link ContextualDataModel} from the given users (and their preferences). This
   ...
   */
  public ContextualDataModel(FastByIDMap<PreferenceArray> userData) {
    this(userData, null);
  }
   ...
   */
  public ContextualDataModel(FastByIDMap<PreferenceArray> userData, FastByIDMap<FastByIDMap<Long>> timestamps) {
  ...
  /**
   * <p>
   * Creates a new {@link ContextualDataModel} containing an immutable copy of the data from another given
   * {@link DataModel}.
   * </p>
   *
   ...
   *  Consider {@link #toDataMap(DataModel)} with {@link #ContextDataModel(FastByIDMap)}
   */
  @Deprecated
  public ContextualDataModel(DataModel dataModel) throws TasteException {
  ...
  public static FastByIDMap<PreferenceArray> toDataMap(FastByIDMap<Collection<Preference>> data,
    ...
    for (Map.Entry<Long,Object> entry : ((FastByIDMap<Object>) (FastByIDMap<?>) data).entrySet()) {
      ...
      entry.setValue(byUser ? new ContextualUserPreferenceArray(prefList) : new ContextualItemPreferenceArray(
          prefList));
    }
  ...
  public String toString() {
    ...
    result.append("ContextualDataModel[users:");
