...
public class PostFilteringContextualBuilderRecommenderTracer implements ContextualRecommenderBuilder {
	...
	public PostFilteringContextualBuilderRecommenderTracer(ContextualRecommenderBuilder recommenderBuilder, 
	...
	public Recommender buildRecommender(DataModel dataModel,
		...
		//if(model instanceof ContextualDataModel){
			return new PostFilteringContextualRecommenderTracer((GenericUserBasedRecommenderTracer) this.recommenderBuilder.buildRecommender(dataModel, criteria, rescorer, dataset),contextualAttributes, this.postFilteringStrategyRecommendation,this.dataset);
