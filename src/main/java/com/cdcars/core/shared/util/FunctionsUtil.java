...
import com.cdcars.core.recommender.scopes.contextual.ContextualPreference;
import com.cdcars.core.recommender.scopes.contextual.ContextualUserPreferenceArray;
import com.cdcars.core.recommender.scopes.contextual.LocationCountryContextualAttribute;
import com.cdcars.core.recommender.scopes.item.ItemDomain;
import com.cdcars.core.recommender.evaluation.PredictionValues;
...
public final class FunctionsUtil {
	...
	/*public static void main(String[] args) {
		//System.out.println("ARICA Y PARINACOTA REGION(311),MASOVIAN VOIVODESHIP(312),REGIóN METROPOLITANA(313),ULAANBAATAR(314),HESSEN(315),HAWKE'S BAY(316),AUST-AGDER(317),YARACUY(318),SALTA(319),AKERSHUS(320),PANAMA(321),PAKTIKA(322),CANTABRIA(323),HLAVNí MěSTO PRAHA(324),VALENCIAN COMMUNITY(325),LARA(326),GORONTALO(327),SAN LUIS(328),SPECIAL CAPITAL REGION OF JAKARTA(329),MIDI-PYRéNéES(330),MANAWATU-WANGANUI(331),NORTHLAND(332),BANSKá BYSTRICA REGION(333),EASTERN PROVINCE(334),SANTIAGO(335),GIZA GOVERNORATE(336),AREQUIPA(337),SANTA CRUZ(338),NORTHEAST(339),QUéBEC(340),MAYAGüEZ(341),NORTHWEST TERRITORIES(342),VENETO(343),CRETE(344),NUEVO LEóN(345),QUERéTARO(346),GUJARAT(347),BRANDENBURG(348),LOWER SAXONY(349),MIE PREFECTURE(350),MPUMALANGA(351),PASTAZA(352),CARINTHIA(353),HAMILTON(354),SINT MAARTEN(355),CANTON OF BERN(356),KſCHI PREFECTURE(357),LA VEGA(358),TOYAMA-KEN(359),MOLISE(360),FRANCHE-COMTé(361),NATIONAL DISTRICT(362),ZEELAND(363),JAWA TIMUR(364),MAłOPOLSKIE(365),NORTHERN PROVINCE(366),TIMIș COUNTY(367),STATE OF RIO DE JANEIRO(368),UPRAVNA ENOTA AJDOVšĿINA(369),ZLIN REGION(370),HAIFA DISTRICT(371),MADEIRA(372),SAINT MICHAEL(373),HOKKAIDO PREFECTURE(374),JIANGSU(375),HEDMARK(376),GYEONGSANGNAM-DO(377),ÖSTERGöTLANDS LäN(378),WALLOON REGION(379),MENDOZA(380),NORTH RHINE-WESTPHALIA(381),".replaceAll("\\s", "_").replaceAll("\\-", "_").replaceAll("\\'", "_"));
